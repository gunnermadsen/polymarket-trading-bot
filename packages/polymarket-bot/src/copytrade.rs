...
use crate::{
    ...
    models::{
        CopyTradeSignal, EffectiveCopyTradeProcessConfig, EffectiveExpectancyFlowProcessConfig,
        ExpectancyFlowCell, ExpectancyFlowWalletCell, OrderRequest, OrderSide, OrderType,
        SignalCandidate, SignalStatus, SignalType, WalletPerformance, WalletScore,
        WalletSegmentPerformance, WhaleTrade,
    },
...
impl From<&WhaleConfig> for CopyTradeConfig {
    fn from(config: &WhaleConfig) -> Self {
        Self {
            ...
            max_open_notional_per_token_usd: Self::default().max_open_notional_per_token_usd,
            max_open_notional_per_market_usd: Self::default().max_open_notional_per_market_usd,
...
impl From<&EffectiveCopyTradeProcessConfig> for CopyTradeConfig {
    fn from(config: &EffectiveCopyTradeProcessConfig) -> Self {
        Self {
            ...
            max_open_notional_per_token_usd: config.max_open_notional_per_token_usd,
            max_open_notional_per_market_usd: config.max_open_notional_per_market_usd,
            copy_size_fraction: config.copy_size_fraction,
...
mod tests {
    ...
    use crate::{
        ...
        models::{ExpectancyFlowCell, ExpectancyFlowWalletCell, OrderSide, WhaleTrade},
        segments::{
