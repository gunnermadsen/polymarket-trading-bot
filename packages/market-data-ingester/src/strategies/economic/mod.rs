//! Economic-data historical ingestion strategies.

macro_rules! define_economic_strategy {
    ($type_name:ident, $key:literal, $name:literal, $description:literal, $dataset:ident) => {
        use super::{backfill_support, types::EconomicDataset};
        use crate::domain::{
...
pub(crate) mod backfill_support;
mod cftc_legacy_futures_backfill;
mod cftc_traders_financial_futures_backfill;
mod fred_economic_series_backfill;
mod new_york_fed_reference_rates_backfill;
mod new_york_fed_soma_holdings_backfill;
pub(crate) mod types;

pub use cftc_legacy_futures_backfill::CftcLegacyFuturesBackfill;
pub use cftc_traders_financial_futures_backfill::CftcTradersFinancialFuturesBackfill;
pub use fred_economic_series_backfill::FredEconomicSeriesBackfill;
pub use new_york_fed_reference_rates_backfill::NewYorkFedReferenceRatesBackfill;
pub use new_york_fed_soma_holdings_backfill::NewYorkFedSomaHoldingsBackfill;
