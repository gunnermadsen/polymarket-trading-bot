...
export class AddBinanceSpotBtcusdtL2OneSecondFeatures1785776400000
  implements MigrationInterface
{
  name = 'AddBinanceSpotBtcusdtL2OneSecondFeatures1785776400000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE polymarket.binance_spot_btcusdt_l2_one_second_features (
        LIKE polymarket.binance_btcusdt_l2_one_second_features
          INCLUDING DEFAULTS INCLUDING STORAGE
      );

      ALTER TABLE polymarket.binance_spot_btcusdt_l2_one_second_features
        ADD CONSTRAINT pk_binance_spot_btcusdt_l2_one_second_features
          PRIMARY KEY (artifact_id, symbol, second_start),
        ADD CONSTRAINT fk_binance_spot_btcusdt_l2_features_artifact
          FOREIGN KEY (artifact_id)
          REFERENCES polymarket.backfill_artifacts (artifact_id)
          ON DELETE RESTRICT,
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_symbol
          CHECK (symbol = 'BTCUSDT'),
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_second_alignment CHECK (
          second_start = date_trunc('second', second_start)
        ),
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_source_update_id
          CHECK (source_update_id >= 0),
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_feature_schema CHECK (
          feature_schema_version =
            'binance-spot-btcusdt-l2-one-second-features-v1'
        ),
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_quality
          CHECK (quality_status = 'qualified'),
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_causality CHECK (
        ...
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_prices CHECK (
          midpoint > 0
          AND microprice > 0
          AND spread_bps >= 0
        ),
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_depth CHECK (
          bid_depth_5 > 0
        ...
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_imbalance CHECK (
        ...
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_shape CHECK (
        ...
        ADD CONSTRAINT chk_binance_spot_btcusdt_l2_flow CHECK (
      ...
      CREATE TABLE polymarket.binance_spot_btcusdt_l2_one_second_features_staging (
        LIKE polymarket.binance_spot_btcusdt_l2_one_second_features
          INCLUDING DEFAULTS INCLUDING CONSTRAINTS INCLUDING STORAGE
      );

      ALTER TABLE polymarket.binance_spot_btcusdt_l2_one_second_features_staging
        ADD CONSTRAINT pk_binance_spot_btcusdt_l2_features_staging
          PRIMARY KEY (artifact_id, symbol, second_start),
        ADD CONSTRAINT fk_binance_spot_btcusdt_l2_staging_artifact
          FOREIGN KEY (artifact_id)
          REFERENCES polymarket.backfill_artifacts (artifact_id)
          ON DELETE RESTRICT;
      ...
      ALTER TABLE polymarket.binance_spot_btcusdt_l2_one_second_features SET (
      ...
      CREATE INDEX idx_binance_spot_btcusdt_l2_artifact_time
        ON polymarket.binance_spot_btcusdt_l2_one_second_features (
          artifact_id, second_start
        );

      CREATE INDEX idx_binance_spot_btcusdt_l2_available_time
        ON polymarket.binance_spot_btcusdt_l2_one_second_features (
    ...
    await queryRunner.query(`
      CREATE FUNCTION polymarket.reject_binance_spot_btcusdt_l2_feature_change()
      RETURNS trigger
      LANGUAGE plpgsql
      AS $$
      BEGIN
      ...
      CREATE TRIGGER trg_reject_binance_spot_btcusdt_l2_feature_change
        BEFORE UPDATE OR DELETE
        ON polymarket.binance_spot_btcusdt_l2_one_second_features
        FOR EACH ROW
        EXECUTE FUNCTION polymarket.reject_binance_spot_btcusdt_l2_feature_change();
    `);
  }
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF EXISTS (
          ...
          RAISE EXCEPTION
            'refusing to remove Binance spot BTCUSDT L2 features while rows exist';
        END IF;
      END;
      $$;

      DROP VIEW polymarket.binance_spot_btcusdt_l2_training_features;
      DROP TRIGGER trg_reject_binance_spot_btcusdt_l2_feature_change
        ON polymarket.binance_spot_btcusdt_l2_one_second_features;
      DROP FUNCTION polymarket.reject_binance_spot_btcusdt_l2_feature_change();
