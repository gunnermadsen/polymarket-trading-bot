...
export class RecoverPmxtArchiveBackfill1785720000000 implements MigrationInterface {
  name = 'RecoverPmxtArchiveBackfill1785720000000';
    ...
    await queryRunner.query(`
      ...
      SET status = 'queued',
          ...
          request = request || jsonb_build_object(
            ...
            'recovery_policy', 'resumable_pmxt_archive_v1',
