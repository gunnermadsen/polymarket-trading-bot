...
export class ReconcileMalformedPmxtExecutionArtifact1785163418000
  implements MigrationInterface
{
  name = 'ReconcileMalformedPmxtExecutionArtifact1785163418000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      WHERE artifact.artifact_id =
              '546d4415-9b3c-42e8-9cb0-e8052ba8de5b'::uuid
