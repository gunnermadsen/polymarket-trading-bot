...
export class RepairFailedPmxtExecutionArtifactState1785161573000
  implements MigrationInterface
{
  name = 'RepairFailedPmxtExecutionArtifactState1785161573000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      WHERE artifact.artifact_id =
              '43368673-7981-48f7-b739-7c9a793badad'::uuid
