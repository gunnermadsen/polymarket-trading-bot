...
const createView = (contracts: string) => `
  ...
  JOIN polymarket.backfill_artifacts artifact
   ...
   AND artifact.metadata ->> 'materialization_contract' IN (${contracts});
`;

export class AllowHuggingFaceBinanceSpotL2Lineage1785866400000
  implements MigrationInterface
{
  name = 'AllowHuggingFaceBinanceSpotL2Lineage1785866400000';
