...
def _render_report(result: dict[str, Any]) -> str:
    lines = [
        ...
        "```json",
        json.dumps(
            result.get("base_model", {}).get("admission"),
            indent=2,
            sort_keys=True,
        ...
        "```json",
        json.dumps(
            result.get("candidate_metrics", {}), indent=2, sort_keys=True, default=_json_default
        ),
        "```",
        "",
        ...
        "```json",
        json.dumps(
            result.get("predictive_selection", {}), indent=2, sort_keys=True, default=_json_default
        ),
        "```",
        "",
        "## Economic admission",
        ...
        "```json",
        json.dumps(
            result.get("economic_admission", {}), indent=2, sort_keys=True, default=_json_default
        ),
        "```",
        "",
        ...
        "```json",
        json.dumps(
            result.get("prospective_qualification", {}),
            indent=2,
            sort_keys=True,
            default=_json_default,
        ),
        ...
        "```json",
        json.dumps(
            result.get("settlement_transition", {}), indent=2, sort_keys=True, default=_json_default
        ),
        "```",
        "",
