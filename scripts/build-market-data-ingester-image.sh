...
export MARKET_DATA_INGESTER_GIT_REVISION="$git_revision"
image="${MARKET_DATA_INGESTER_IMAGE:-capitonic/market-data-ingester:development}"

docker compose \
  -f docker-compose.yml \
  -f packages/market-data-ingester/docker-compose.yml \
  --profile market-data-ingestion \
  build market-data-ingester
